...
# ==========================================
# 6. ՊԱՏՄԱԿԱՆԻ ԵՎ ԱՊԱԳԱՅԻ ՎԻԶՈՒԱԼԻԶԱՑԻԱ (ԵՐԿՈՒ ԱՌԱՆՁԻՆ ԷՋԵՐՈՎ)
# ==========================================

print("\n--- ԳՐԱՖԻԿՆԵՐԻ ԿԱՌՈՒՑՈՒՄ (ԱՌԱՆՁԻՆ ՆԿԱՐՆԵՐՈՎ) ---")

# Վերցնում ենք 1 ինվերտոր վերջին 30 օրվա համար (~720 ժամ)
...
# Առանցքների մանրամասն բաժանում Էջ 1-ի համար
ax1 = plt.gca()
...
# Պահպանում և ցուցադրում ենք առաջին էջը
plt.savefig('Part_1_Historical_Backtest.png', dpi=300)
plt.show() 
# Երբ փակես առաջին գրաֆիկի պատուհանը, կբացվի երկրորդը:
...
# Առանցքների մանրամասն բաժանում Էջ 2-ի համար
ax2 = plt.gca()
...
# Պահպանում և ցուցադրում ենք երկրորդ էջը
